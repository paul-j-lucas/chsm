...
//*****************************************************************************
{
    ...
    bool const          public_;                // declared public?
    ...
    static char const chsm_package_name_[];
    ...
    chsm_info( PJL::symbol *root, bool is_public, char const *derived = 0 );
