...
**      java/lib/CHSM/Machine.java -- Run-Time library implementation
**
...
public abstract class Machine implements Iterable<State> {
    ...
    public static final int D_NONE  = 0x00;

    /** Prints entrances to and exits from states. */
    public static final int D_ENEX  = 0x01;

    /** Prints events queueing and dequeuing. */
    public static final int D_EVENT = 0x02;

    /** Reports progress during the broadcast algorithm. */
    public static final int D_ALG   = 0x04;

    /** Reports all debugging information. */
    public static final int D_ALL   = D_ENEX | D_EVENT | D_ALG;
     ...
     * debugging states {@link #D_ENEX}, {@link #D_EVENT}, {@link #D_ALG}, or
     * {@link #D_ALL}.
